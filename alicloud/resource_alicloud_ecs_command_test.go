...
func TestUnitAliCloudECSCommand(t *testing.T) {
	...
	responseMock := map[string]func(errorCode string) (map[string]interface{}, error){
		...
		"CreateNormal": func(errorCode string) (map[string]interface{}, error) {
			result := ReadMockResponse
			result["CommandId"] = "MockCommandId"
			return result, nil
		},
		...
		"ReadDescribeEcsCommandNotFound": func(errorCode string) (map[string]interface{}, error) {
	...
	t.Run("CreateClientAbnormal", func(t *testing.T) {
		...
		err := resourceAliCloudEcsCommandCreate(d, rawClient)
		patches.Reset()
		assert.NotNil(t, err)
	})
	...
	t.Run("CreateNormal", func(t *testing.T) {
		...
		err := resourceAliCloudEcsCommandCreate(dCreate, rawClient)
		patches.Reset()
		assert.Nil(t, err)
	})
	...
	t.Run("DeleteClientAbnormal", func(t *testing.T) {
		...
		err := resourceAliCloudEcsCommandDelete(d, rawClient)
		patches.Reset()
		assert.NotNil(t, err)
	})
	...
	//Read
	t.Run("ReadDescribeEcsCommandNotFound", func(t *testing.T) {
		patcheDorequest := gomonkey.ApplyMethod(reflect.TypeOf(&client.Client{}), "DoRequest", func(_ *client.Client, _ *string, _ *string, _ *string, _ *string, _ *string, _ map[string]interface{}, _ map[string]interface{}, _ *util.RuntimeOptions) (map[string]interface{}, error) {
			NotFoundFlag := true
			noRetryFlag := false
			if NotFoundFlag {
				return responseMock["ReadDescribeEcsCommandNotFound"]("")
			} else if noRetryFlag {

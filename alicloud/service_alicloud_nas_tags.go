...
// ListTagResources lists tag resources for NAS
...
// DescribeFileSystemListTagResources lists tag resources for file system (v2 version)
func (s *NasService) DescribeFileSystemListTagResources(id string) (object map[string]interface{}, err error) {
	client := s.client
...
// SetResourceTags sets resource tags for NAS resources

...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_selectdb_db_clusters":                             dataSourceAliCloudSelectDBClusters(),
			"alicloud_selectdb_db_instances":                            dataSourceAliCloudSelectDBInstances(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_selectdb_db_cluster":                                   resourceAliCloudSelectDBCluster(),
			"alicloud_selectdb_db_instance":                                  resourceAliCloudSelectDBInstance(),

...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_adbpg_accounts":                                   dataSourceAliCloudAdbpgAccounts(),
			"alicloud_adbpg_backups":                                    dataSourceAliCloudAdbpgBackups(),
			"alicloud_adbpg_data_sources":                               dataSourceAliCloudAdbpgDataSources(),
			"alicloud_adbpg_instance_plans":                             dataSourceAliCloudAdbpgInstancePlans(),
			"alicloud_adbpg_instances":                                  dataSourceAliCloudAdbpgInstances(),
			"alicloud_adbpg_namespaces":                                 dataSourceAliCloudAdbpgNamespaces(),
			"alicloud_adbpg_resource_groups":                            dataSourceAliCloudAdbpgResourceGroups(),
			"alicloud_adbpg_streaming_jobs":                             dataSourceAliCloudAdbpgStreamingJobs(),
			"alicloud_adbpg_supabase_projects":                          dataSourceAliCloudAdbpgSupabaseProjects(),
			"alicloud_adbpg_vector_collections":                         dataSourceAliCloudAdbpgVectorCollections(),
			"alicloud_adbpg_zones":                                      dataSourceAliCloudAdbpgZones(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_adbpg_account":                                         resourceAliCloudAdbpgAccount(),
			"alicloud_adbpg_backup_policy":                                   resourceAliCloudAdbpgBackupPolicy(),
			"alicloud_adbpg_connection":                                      resourceAliCloudAdbpgConnection(),
			"alicloud_adbpg_database":                                        resourceAliCloudAdbpgDatabase(),
			"alicloud_adbpg_instance":                                        resourceAliCloudAdbpgInstance(),
			"alicloud_adbpg_security_ip_array":                               resourceAliCloudAdbpgSecurityIpArray(),
			"alicloud_adbpg_ssl":                                             resourceAliCloudAdbpgSsl(),
			"alicloud_adbpg_vector_collection":                               resourceAliCloudAdbpgVectorCollection(),
			...
			"alicloud_cms_addon":                                             resourceAliCloudCmsAddon(),
			...
			"alicloud_cms_alert":                                             resourceAliCloudCmsAlert(),
			...
			"alicloud_cms_prometheus":                                        resourceAliCloudCmsPrometheus(),
			...
			"alicloud_log_collection_policy":                                 resourceAliCloudLogCollectionPolicy(),
			...
			"alicloud_log_scheduled_sql":                                     resourceAliCloudLogScheduledSQL(),

...
type AssumeRoleResponse struct {
	*responses.BaseResponse
	...
	Credentials     CredentialsInAssumeRole     `json:"Credentials" xml:"Credentials"`
	AssumedRoleUser AssumedRoleUserInAssumeRole `json:"AssumedRoleUser" xml:"AssumedRoleUser"`
}

...
// Deployment methods
func (s *FlinkService) GetDeployment(id string) (*flinkAPI.Deployment, error) {
...
func (s *FlinkService) CreateDeployment(namespaceName *string, deployment *flinkAPI.Deployment) (*flinkAPI.Deployment, error) {
	deployment.Namespace = *namespaceName
	return s.flinkAPI.CreateDeployment(deployment)
}

func (s *FlinkService) UpdateDeployment(deployment *flinkAPI.Deployment) (*flinkAPI.Deployment, error) {
...
func (s *FlinkService) ListDeployments(namespaceName string) ([]flinkAPI.Deployment, error) {

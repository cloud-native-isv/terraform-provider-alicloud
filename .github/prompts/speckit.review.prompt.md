...
5. **Report summary back to the user**:
    - Present a short summary including:
       - FEATURE_KEY and feature name (for artifact scoping only)
    ...
    - If any core artifacts were missing (e.g. `spec.md` or `plan.md`), clearly state what was missing and how that affected the process review.

...
Run: ./scripts/bash/plan.sh "echo \"Price is \\$100 & it's 50% off!\" | grep '50%'"
Expected: Command executes safely without shell interpretation

### Test 2: Unicode Characters  
Run: ./scripts/bash/plan.sh "echo \"Hello 世界! 👋\""
Expected: Command outputs exact Unicode string

### Test 3: Combined Input
Run: ./scripts/bash/plan.sh "echo \"The price in 中国 is \\$100 & it's 50% off! 🎉\""

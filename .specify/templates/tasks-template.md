...
**Tests**: The examples below include test tasks. Tests are MANDATORY per Constitution Principle III (Test-First Development) and IV (Integration & Contract Testing).

...
| 013 | Flink Workspace Capacity Allocation | Workspace purchase 与可重试的 PRE 容量、namespace、implicit queue 权威收敛分离 | Implemented; local integration and final review complete, deployment pending | [Details](features/013.md) | docs/superpowers/specs/2026-07-16-flink-workspace-capacity-allocation-design.md | 2026-07-20 |
